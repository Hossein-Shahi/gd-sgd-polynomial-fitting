"""Figure generation from seed-0 runs of the optimizer code.

Produces the two remaining main-text figures (weight trajectories, instability)
plus the appendix gallery: fit, loss, and weights for each of the nine
(degree, lr) configurations."""
